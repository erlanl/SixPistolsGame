...
class Tiro:
    ...
    def colisao_bala(self, obj, colidor):
...
class Player:
    ...
    def __init__(self, win, x, y, tecla_cima, tecla_baixo, tecla_esquerda, tecla_direita, tecla_tiro, inimigo):
...
def main():
    ...
    while not done:
        ...
        for bala in Balas.lista_balas:
            if bala.rect.colliderect(player1.quadrado):
            ...
            if bala.rect.colliderect(player2.quadrado):
