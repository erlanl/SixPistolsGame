...
def main():
    ...
    player2 = Player(screen, 220, 140, pg.K_UP, pg.K_DOWN, pg.K_LEFT, pg.K_RIGHT, pg.K_RCTRL, None,(screen.get_width()-90),530,fonte_pontuacao, 'imagens/cowgirl_leila.png')
    ...
    while not done:
        ...
        if player1.direcao == "baixo":
            player1.imagem = pygame.image.load('cowboy_joaquim2.png')
        elif player1.direcao == "cima":
            player1.imagem =  pygame.image.load('cowboy_joaquim2_costas.png')

        if player2.direcao == "baixo":
            player2.imagem = pygame.image.load('cowgirl_leila.png')
        elif player2.direcao == "cima":
            player2.imagem = pygame.image.load('cowgirl_leila.costas.png')
