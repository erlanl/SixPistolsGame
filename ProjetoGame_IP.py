...
def main():
    ...
    while not done:
        ...
        player1.movimento([plataforma_superior_direita.plataforma, plataforma_meio.plataforma], pg.K_w, pg.K_s, pg.K_a, pg.K_d)
        player2.movimento([plataforma_superior_direita.plataforma, plataforma_meio.plataforma], pg.K_UP, pg.K_DOWN, pg.K_LEFT, pg.K_RIGHT)
